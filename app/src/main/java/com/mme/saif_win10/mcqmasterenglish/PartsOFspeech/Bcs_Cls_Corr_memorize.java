 ...
 */
public class Bcs_Cls_Corr_memorize extends Fragment {
    View rootView;
    private RecyclerView mRecycler_BcsMemorize;
    private DatabaseReference mDatabase;

    public Bcs_Cls_Corr_memorize() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference().child("bcs_cls_corr_memorize");
                    ...
                    protected void populateViewHolder(ParameterViewHolder viewHolder, Parameter model, int position) {
                        ...
                        viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                intent.putExtra("childName", "bcs_cls_corr_memorize");
